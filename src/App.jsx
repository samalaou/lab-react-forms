...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const newStudent = { fullName, image, phone, email, program, graduationYear, isGraduated };
    ...
    <div className="App pt-20">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <label>
            Graduated
            <input name="graduated" type="checkbox" value={isGraduated} onChange={e => setIsgraduated(e.target.checked)}/>
          </label>
